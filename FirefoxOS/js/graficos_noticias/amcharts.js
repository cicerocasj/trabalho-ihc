...
AmCharts.wrappedText = function (a, b, c, d, e, f, g, h, k) {
    ...
    if (l) {
        ...
        if (p.width > h) {
            ...
            for (var s = Math.round(b.length / 2), q = 1E3, r, n = 0; n < l.length; n++) {
                var u = Math.abs(l[n] - s);
                u < q && (r = l[n], q = u)
            }
            if (isNaN(r)) {
                h = Math.ceil(p.width / h);
                for (n = 1; n < h; n++)r = Math.round(b.length / h * n), b = b.substr(0, r) + m + b.substr(r);
                return AmCharts.text(a, b, c, d, e, f,
                    g)
            }
...
AmCharts.addPrefix = function (a, b, c, d, e) {
    ...
    if (1 < a)for (h = b.length - 1; -1 < h; h--) {
        if (a >= b[h].number && (k = a / b[h].number, l = Number(d.precision), 1 > l && (l = 1), c = AmCharts.roundTo(k, l), l = AmCharts.formatNumber(c, {precision: -1, decimalSeparator: d.decimalSeparator, thousandsSeparator: d.thousandsSeparator}), !e || k == c)) {
            f = g + "" + l + "" + b[h].prefix;
            break
        }
...
AmCharts.AxisBase = AmCharts.Class({construct: function (a) {
    ...
    if (a) {
        ...
        0 < d.length() ? e = d.getBBox() : (e.x = 0, e.y = 0, e.width = this.viW, e.height =
            this.viH);
        d.push(a);
        var d = e.x, f = e.y;
        AmCharts.VML && (this.rotate ? d -= this.x : f -= this.y);
        var g = e.width, e = e.height, h = this.viW, k = this.viH, l = 0, m = a.getBBox().height / 2, p = this.inside, n = this.titleAlign;
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function (a) {
    ...
    if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
        ...
        if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)g = !0; else {
            var k = this.labelFrequency, l = this.showFirstLabel, m = this.showLastLabel, p = 1, n = 0, s = Math.round((this.max - this.min) / this.step) + 1, q;
            !0 === h ? (q = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth = this.axisWidth / q,
                q > this.logGridLimit && (s = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, n = Math.round(Math.log(this.minReal) * Math.LOG10E), s > this.gridCountR && (p = Math.ceil(s / this.gridCountR)))) : this.stepWidth = this.axisWidth / (this.max - this.min);
            var r = 0;
            ...
            var t, w = this.guides, x = w.length;
            if (0 < x) {
                c = this.fillAlpha;
                for (d = this.fillAlpha = 0; d < x; d++) {
                    var F = w[d], z = NaN, A = F.above;
                    isNaN(F.toValue) || (z = this.getCoordinate(F.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, F), this.pushAxisItem(t, A));
                    var I = NaN;
                    isNaN(F.value) || (I = this.getCoordinate(F.value), t = new this.axisItemRenderer(this, I, F.label, !0,
                        NaN, (z - I) / 2, F), this.pushAxisItem(t, A));
                    isNaN(z - I) || (t = new this.guideFillRenderer(this, I, z, F), this.pushAxisItem(t, A), t = t.graphics(), F.graphics = t, F.balloonText && this.addEventListeners(t, F))
                }
                this.fillAlpha = c
            }
            w = !1;
            for (d = n; d < s; d += p)x = AmCharts.roundTo(this.step * d + this.min, r), -1 != String(x).indexOf("e") && (w = !0, String(x).split("e"));
            this.duration && (this.maxInterval = AmCharts.getMaxInterval(this.max, this.duration));
            var r = this.step, K, x = this.minorGridAlpha;
            this.minorGridEnabled && (K = this.getMinorGridStep(r, this.stepWidth *
                r));
            for (d = n; d < s; d += p)if (n = r * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n)if (isNaN(u) || Number(AmCharts.toFixed(n, u)) == n) {
                !0 === h && (0 === n && (n = this.minReal), q > this.logGridLimit && (n = Math.pow(10, d)), w = -1 != String(n).indexOf("e") ? !0 : !1);
                ...
                if (n == this.baseValue && "radar" != a.type) {
                    var B, J, A = this.viW, z = this.viH;
                    t = this.viX;
                    F = this.viY;
                    "H" == this.orientation ? 0 <= c && c <= A + 1 && (B = [c, c, c + e], J = [z, 0, f]) : 0 <= c && c <= z + 1 && (B = [0, A, A + e], J = [c, c, c + f]);
                    B && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), c = AmCharts.line(a.container, B, J, this.gridColor, c, 1, this.dashLength), c.translate(t, F), this.grid0 = c, a.axesSet.push(c),
                        c.toBack())
                }
                if (!isNaN(K) && 0 < x && d < s - 1) {
                    t = this.gridAlpha;
        ...
        d = this.labelsSet;
        this.positionTitle();
        "radar" != a.type ? (a = this.viX, e = this.viY, b.translate(a, e), d.translate(a, e)) : h.toFront();
    ...
    for (var d = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E), e = 0; e < c.length; e++) {
        var f = a / c[e], g = Math.floor(Math.log(Math.abs(f)) *
            Math.LOG10E);
    ...
    "100% stacked" == b && (b = "100%");
    this.stackType = b;
    var c = [], d = [], e = [], f = [], g, h = this.chart.graphs, k, l, m, p, n = this.baseValue, s = !1;
    if ("line" == a || "step" == a || "smoothedLine" == a)s = !0;
    if (s && ("regular" == b || "100%" == b))for (p = 0; p < h.length; p++)m = h[p], m.hidden || (l = m.type, m.chart == this.chart && m.valueAxis ==
    ...
    for (k = this.start; k <= this.end; k++) {
        ...
        for (p = 0; p < h.length; p++)if (m = h[p], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, !isNaN(g)))) {
            ...
            r = m.fillToGraph;
            s && r && (r = this.data[k].axes[this.id].graphs[r.id]) && (l.values.open = r.values.value);
            "regular" ==
                b && (s && (isNaN(c[k]) ? (c[k] = g, l.values.close = g, l.values.open = this.baseValue) : (isNaN(g) ? l.values.close = c[k] : l.values.close = g + c[k], l.values.open = c[k], c[k] = l.values.close)), "column" != a || isNaN(g) || (m.newStack && (e[k] = NaN, d[k] = NaN), l.values.close = g, 0 > g ? (l.values.close = g, isNaN(d[k]) ? l.values.open = n : (l.values.close += d[k], l.values.open = d[k]), d[k] = l.values.close) : (l.values.close = g, isNaN(e[k]) ? l.values.open = n : (l.values.close += e[k], l.values.open = e[k]), e[k] = l.values.close)))
        }
    }
    for (k = this.start; k <= this.end; k++)for (p =
    ...
    for (b = 0; b < a.length; b++) {
        ...
        if (c.valueAxis == this) {
            ...
            for (d = h; d <= g; d++) {
                ...
                f.percents = {};
                var h = f.values, l;
                for (l in h)f.percents[l] = "percents" != l ?
                    h[l] / e * 100 - 100 : h[l]
            }
        }
    }
    ...
    "100%" == this.stackType &&
    (this.min = 0 > this.min ? -100 : 0, this.max = 0 > this.max ? 0 : 100);
    c = this.max - this.min;
    ...
    1 > c ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) * Math.LOG10E), this.maxDecCount = Math.round(this.maxDecCount), this.step = AmCharts.roundTo(this.step,
        this.maxDecCount + 1)) : this.maxDecCount = 0;
    ...
    0 < this.min && 0 < this.minReal - this.step && (this.minReal = this.min + this.step <
        this.minReal ? this.min + this.step : this.min);
    ...
    c.chart = this.chart;
    c.valueAxis = this;
    c.multiplier = this.axisWidth / Math.abs(this.getCoordinate(b) -
        this.getCoordinate(a));
...
AmCharts.RecAxis = AmCharts.Class({construct: function (a) {
    var b = a.chart, c = a.axisThickness, d = a.axisColor, e = a.axisAlpha, f = a.offset, g = a.dx, h = a.dy, k = a.viX, l = a.viY, m = a.viH, p = a.viW, n = b.container;
    "H" == a.orientation ? (d = AmCharts.line(n, [0, p], [0, 0], d, e, c), this.axisWidth = a.width, "bottom" == a.position ? (a = c / 2 + f + m + l - 1, c = k) : (a = -c / 2 - f + l + h, c = g + k)) : (this.axisWidth = a.height, "right" == a.position ? (d = AmCharts.line(n, [0, 0, -g], [0, m, m - h], d, e, c), a = l + h, c = c / 2 + f + g + p + k - 1) : (d = AmCharts.line(n, [0, 0], [0, m], d, e, c), a = l, c = -c / 2 - f + k));
    d.translate(c,
        a);
    b.axesSet.push(d);
    this.set = d
}});
AmCharts.RecItem = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l) {
    b = Math.round(b);
    void 0 == c && (c = "");
    k || (k = 0);
    void 0 == d && (d = !0);
    ...
    this.set = q;
    var r = a.axisThickness, u = a.axisColor, v = a.axisAlpha, t = a.tickLength, w = a.gridAlpha, x = a.gridThickness, F = a.gridColor, z = a.dashLength, A = a.fillColor, I = a.fillAlpha, K = a.labelsEnabled, B = a.labelRotation, J = a.counter, M = a.inside,
        ca = a.dx, U = a.dy, Na = a.orientation, ga = a.position, ma = a.previousCoord, S = a.viH, V = a.viW, $ = a.offset, ra, P;
    g ? (K = !0, isNaN(g.tickLength) || (t = g.tickLength), void 0 != g.lineColor && (F = g.lineColor), void 0 != g.color && (n = g.color), isNaN(g.lineAlpha) || (w = g.lineAlpha), isNaN(g.dashLength) || (z = g.dashLength), isNaN(g.lineThickness) || (x = g.lineThickness), !0 === g.inside && (M = !0), isNaN(g.labelRotation) || (B = g.labelRotation), isNaN(g.fontSize) || (p = g.fontSize), g.position && (ga = g.position)) : "" === c && (t = 0);
    P = "start";
    e && (P = "middle");
    var W =
        B * Math.PI / 180, pa, G = 0, E = 0, T = 0, da = pa = 0, ha = 0;
    "V" == Na && (B = 0);
    var y;
    K && (y = a.autoWrap && 0 === B ? AmCharts.wrappedText(s, c, n, m, p, P, h, e, 0) : AmCharts.text(s, c, n, m, p, P, h), P = y.getBBox(), da = P.width, ha = P.height);
    if ("H" == Na) {
        if (0 <= b && b <= V + 1 && (0 < t && 0 < v && b + k <= V + 1 && (ra = AmCharts.line(s, [b + k, b + k], [0, t], u, v, x), q.push(ra)), 0 < w && (P = AmCharts.line(s, [b, b + ca, b + ca], [S, S + U, U], F, w, x, z), q.push(P))), E = 0, G = b, g && 90 == B && (G -= p), !1 === d ? (P = "start", E = "bottom" == ga ? M ? E + t : E - t : M ? E - t : E + t, G += 3, e && (G += e / 2, P = "middle"), 0 < B && (P = "middle")) : P = "middle",
            1 == J && 0 < I && !g && !l && ma < V && (d = AmCharts.fitToBounds(b, 0, V), ma = AmCharts.fitToBounds(ma, 0, V), pa = d - ma, 0 < pa && (fill = AmCharts.rect(s, pa, a.height, A, I), fill.translate(d - pa + ca, U), q.push(fill))), "bottom" == ga ? (E += S + p / 2 + $, M ? 0 < B ? (E = S - da / 2 * Math.sin(W) - t - 3, G += da / 2 * Math.cos(W) - 4 + 2) : 0 > B ? (E = S + da * Math.sin(W) - t - 3 + 2, G += -da * Math.cos(W) - ha * Math.sin(W) - 4) : E -= t + p + 3 + 3 : 0 < B ? (E = S + da / 2 * Math.sin(W) + t + 3, G -= da / 2 * Math.cos(W)) : 0 > B ? (E = S + t + 3 - da / 2 * Math.sin(W) + 2, G += da / 2 * Math.cos(W)) : E += t + r + 3 + 3) : (E += U + p / 2 - $, G += ca, M ? 0 < B ? (E = da / 2 * Math.sin(W) +
            t + 3, G -= da / 2 * Math.cos(W)) : E += t + 3 : 0 < B ? (E = -(da / 2) * Math.sin(W) - t - 6, G += da / 2 * Math.cos(W)) : E -= t + p + 3 + r + 3), "bottom" == ga ? pa = (M ? S - t - 1 : S + r - 1) + $ : (T = ca, pa = (M ? U : U - t - r + 1) - $), f && (G += f), U = G, 0 < B && (U += da / 2 * Math.cos(W)), y && (ga = 0, M && (ga = da / 2 * Math.cos(W)), U + ga > V + 2 || 0 > U))y.remove(), y = null
    } else {
        0 <= b && b <= S + 1 && (0 < t && 0 < v && b + k <= S + 1 && (ra = AmCharts.line(s, [0, t], [b + k, b + k], u, v, x), q.push(ra)), 0 < w && (P = AmCharts.line(s, [0, ca, V + ca], [b, b + U, b + U], F, w, x, z), q.push(P)));
        P = "end";
        if (!0 === M && "left" == ga || !1 === M && "right" == ga)P = "start";
        E = b - p / 2;
        1 ==
            J && 0 < I && !g && !l && (d = AmCharts.fitToBounds(b, 0, S), ma = AmCharts.fitToBounds(ma, 0, S), W = d - ma, fill = AmCharts.polygon(s, [0, a.width, a.width, 0], [0, 0, W, W], A, I), fill.translate(ca, d - W + U), q.push(fill));
        E += p / 2;
        "right" == ga ? (G += ca + V + $, E += U, M ? (G -= t + 4, f || (E -= p / 2 + 3)) : (G += t + 4 + r, E -= 2)) : M ? (G += t + 4 - $, f || (E -= p / 2 + 3), g && (G += ca, E += U)) : (G += -t - r - 4 - 2 - $, E -= 2);
        ra && ("right" == ga ? (T += ca + $ + V, pa += U, T = M ? T - r : T + r) : (T -= $, M || (T -= t + r)));
        f && (E += f);
        M = -3;
        "right" == ga && (M += U);
        y && (E > S + 1 || E < M) && (y.remove(), y = null)
    }
    ra && ra.translate(T, pa);
    !1 === a.visible &&
    (ra && ra.remove(), y && (y.remove(), y = null));
    y && (y.attr({"text-anchor": P}), y.translate(G, E), 0 !== B && y.rotate(-B, a.chart.backgroundColor), a.allLabels.push(y), " " != c && (this.label = y));
    l || (a.counter = 0 === J ? 1 : 0, a.previousCoord = b);
...
AmCharts.AmChart = AmCharts.Class({construct: function (a) {
    ...
    this.container = a;
    if (AmCharts.VML || AmCharts.SVG)a = this.container, this.set = a.set(), this.gridSet = a.set(), this.cursorLineSet =
    ...
    var a = this.div, b = this.chartDiv, c = a.offsetWidth, d = a.offsetHeight,
        e = this.container;
    ...
    a = AmCharts.toCoordinate(this.width,
        c);
    f = AmCharts.toCoordinate(this.height, d);
    this.balloon = AmCharts.processObject(this.balloon, AmCharts.AmBalloon, this.theme);
    this.balloon.chart = this;
    if (a != this.previousWidth || f != this.previousHeight)b.style.width = a + "px", b.style.height = f + "px", e && e.setSize(a, f);
    ...
    clearLabels: function () {
        ...
        if ("amcharts.com" != b) {
            ...
            var f =
                "#", g = "Feito por Cícero - Raphael - Rodrigo", h = "Feito por Cícero - Raphael - Rodrigo";
...
AmCharts.AmGraph = AmCharts.Class({construct: function (a) {
    ...
    this.bulletSet = d;
    this.scrollbar || (e = a.marginLeftReal, a = a.marginTopReal,
    ...
    var a = this.chart, b = this.id, c = this.index, d = this.data, e = this.chart.container, f = this.valueAxis, g = this.type, h =
        this.columnWidthReal, k = this.showBulletsAt;
    isNaN(this.columnWidth) || (h = this.columnWidth);
    isNaN(h) && (h = 0.8);
    var l = this.width, m = this.height, p = this.y, n = this.rotate, s = this.columnCount, q = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), r = this.connect, u = [], v = [], t, w, x, F, z = this.chart.graphs.length, A, I = this.dx / this.depthCount, K = this.dy / this.depthCount, B = f.stackType, J = this.labelPosition, M = this.start, ca = this.end, U = this.scrollbar, Na = this.categoryAxis, ga = this.baseCoord, ma = this.negativeBase, S = this.columnIndex, V =
        this.lineThickness, $ = this.lineAlpha, ra = this.lineColorR, P = this.dashLength, W = this.set, pa = J, G = this.getGradRotation(), E = this.chart.columnSpacing, T = Na.cellWidth, da = (T * h - s) / s;
    E > da && (E = da);
    var ha, y, Wa, eb = m + 1, fb = l + 1, Xa = 0, gb = 0, hb, ib, Ya, Za, Ob = this.fillColorsR, Oa = this.negativeFillColors, Da = this.negativeLineColor, Pa = this.fillAlphas, Qa = this.negativeFillAlphas;
    "object" == typeof Pa && (Pa = Pa[0]);
    "object" == typeof Qa && (Qa = Qa[0]);
    var $a = f.getCoordinate(f.min);
    f.logarithmic && ($a = f.getCoordinate(f.minReal));
    this.minCoord =
        $a;
    ...
    if (!U && ("line" == g || "smoothedLine" == g || "step" == g) && (1 == d.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), Oa || void 0 != Da)) {
        ...
        Ha > f.max && (Ha = f.max);
        Ha < f.min && (Ha = f.min);
        f.logarithmic && (Ha = f.minReal);
        var ya = f.getCoordinate(Ha), yb = f.getCoordinate(f.max);
        n ? (eb = m, fb = Math.abs(yb - ya), hb = m, ib = Math.abs($a - ya), Za = gb = 0, f.reversed ? (Xa = 0, Ya = ya) : (Xa = ya, Ya = 0)) : (fb = l, eb = Math.abs(yb - ya), ib = l, hb = Math.abs($a - ya), Ya = Xa = 0, f.reversed ? (Za =
            p, gb = ya) : Za = ya + 1)
    }
    var za = Math.round;
    this.pmx = za(Xa);
    ...
    h = "column" == g ? (T * h - E * (s - 1)) / s : T * h;
    1 > h && (h = 1);
    var H;
    if ("line" == g || "step" == g || "smoothedLine" == g) {
        if (0 < M) {
            for (H = M - 1; -1 < H; H--)if (ha = d[H], y = ha.axes[f.id].graphs[b], Wa = y.values.value, !isNaN(Wa)) {
                M = H;
                break
            }
            if (this.lineColorField)for (H = M; -1 < H; H--)if (ha = d[H], y = ha.axes[f.id].graphs[b],
                y.lineColor) {
                this.bulletColorSwitched = this.lineColorSwitched = y.lineColor;
                break
            }
            if (this.fillColorsField)for (H = M; -1 < H; H--)if (ha = d[H], y = ha.axes[f.id].graphs[b], y.fillColors) {
                this.fillColorsSwitched = y.fillColors;
                break
            }
            if (this.dashLengthField)for (H = M; -1 < H; H--)if (ha = d[H], y = ha.axes[f.id].graphs[b], !isNaN(y.dashLength)) {
                this.dashLengthSwitched = y.dashLength;
                break
            }
        }
        if (ca < d.length - 1)for (H = ca + 1; H < d.length; H++)if (ha = d[H], y = ha.axes[f.id].graphs[b], Wa = y.values.value, !isNaN(Wa)) {
            ca = H;
            break
        }
    }
    ...
    var X =
        [], Y = [], Ea = !1;
    if ("line" == g || "step" == g || "smoothedLine" == g)if (this.stackable && "regular" == B || "100%" == B || this.fillToGraph)Ea = !0;
    var zb = this.noStepRisers, ab = -1E3, bb = -1E3, cb = this.minDistance;
    for (H = M; H <= ca; H++) {
        ha = d[H];
        y = ha.axes[f.id].graphs[b];
        y.index = H;
        var Q, R, O, aa, ia = NaN, D = NaN, C = NaN, N = NaN, L = NaN, Ia = NaN, Aa = NaN, Ja = NaN, Ba = NaN, ba = NaN, fa = NaN, ja = NaN, ka = NaN, Z = NaN, jb = NaN, kb = NaN, na = NaN, qa = void 0, Ca = Ob, Ra = Pa, sa = ra, oa, ta, Sa = this.pattern;
        void 0 != y.pattern && (Sa = y.pattern);
        void 0 != y.color && (Ca = y.color);
        y.fillColors &&
        (Ca = y.fillColors);
        isNaN(y.alpha) || (Ra = y.alpha);
        isNaN(y.dashLength) || (P = y.dashLength);
        var ua = y.values;
        f.recalculateToPercents && (ua = y.percents);
        if (ua) {
            Z = this.stackable && "none" != B && "3d" != B ? ua.close : ua.value;
            if ("candlestick" == g || "ohlc" == g)Z = ua.close, kb = ua.low, Aa = f.getCoordinate(kb), jb = ua.high, Ba = f.getCoordinate(jb);
            na = ua.open;
            C = f.getCoordinate(Z);
            isNaN(na) || (L = f.getCoordinate(na));
            ...
            var ia = ha.x[Na.id], Ka = this.periodSpan - 1, la = Math.floor(T / 2) + Math.floor(Ka * T / 2), va = la, Ab = 0;
            "left" == this.stepDirection && (Ab = (2 * T + Ka * T) / 2, ia -= Ab);
            "start" == this.pointPosition && (ia -= T / 2 + Math.floor(Ka * T / 2), la = 0, va = Math.floor(T) + Math.floor(Ka * T));
            "end" == this.pointPosition && (ia += T / 2 + Math.floor(Ka * T / 2), la = Math.floor(T) + Math.floor(Ka * T), va = 0);
            if (zb) {
            ...
            -1E5 > ia && (ia = -1E5);
            ia > l + 1E5 && (ia = l + 1E5);
            n ? (D = C, N = L, L = C = ia, isNaN(na) && !this.fillToGraph && (N = ga),
                Ia = Aa, Ja = Ba) : (N = D = ia, isNaN(na) && !this.fillToGraph && (L = ga));
            Z < na && (y.isNegative = !0, Oa && (Ca = Oa), Qa && (Ra = Qa), void 0 != Da && (sa = Da));
            switch (g) {
                case "line":
                    if (isNaN(Z))r || (this.drawLineGraph(u, v, X, Y), u = [], v = [], X = [], Y = []); else {
                        y.isNegative = Z < ma ? !0 : !1;
                        if (Math.abs(D - ab) >= cb || Math.abs(C - bb) >= cb)u.push(D), v.push(C), ab = D, bb = C;
                        ba = D;
                        fa = C;
                        ja = D;
                        ka = C;
                        !Ea || isNaN(L) || isNaN(N) || (X.push(N), Y.push(L));
                        void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(u, v, X, Y), u = [D], v = [C], X = [], Y = [], !Ea ||
                            isNaN(L) || isNaN(N) || (X.push(N), Y.push(L)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength)
                    }
                    break;
                case "smoothedLine":
                    if (isNaN(Z))r || (this.drawSmoothedGraph(u, v, X, Y), u = [], v = [], X = [], Y = []); else {
                        ...
                        ka = C;
                        !Ea || isNaN(L) || isNaN(N) || (X.push(N), Y.push(L));
                        void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawSmoothedGraph(u,
                            v, X, Y), u = [D], v = [C], X = [], Y = [], !Ea || isNaN(L) || isNaN(N) || (X.push(N), Y.push(L)), this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength)
                    }
                    break;
                case "step":
                    if (!isNaN(Z))y.isNegative = Z < ma ? !0 : !1, void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) || (this.drawLineGraph(u, v, X, Y), u = [], v = [], X = [], Y = [], this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched = y.dashLength), n ? (isNaN(t) || (u.push(t), v.push(C - la)),
                        v.push(C - la), u.push(D), v.push(C + va), u.push(D), !Ea || isNaN(L) || isNaN(N) || (X.push(x), Y.push(L - la), X.push(N), Y.push(L - la), X.push(N), Y.push(L + va))) : (isNaN(w) || (v.push(w), u.push(t), v.push(w), u.push(D - la)), u.push(D - la), v.push(C), u.push(D + va), v.push(C), !Ea || isNaN(L) || isNaN(N) || (X.push(N - la), Y.push(F), X.push(N - la), Y.push(L), X.push(N + va), Y.push(L))), t = D, w = C, x = N, F = L, ba = D, fa = C, ja = D, ka = C, zb && (t = w = NaN, this.drawLineGraph(u, v, X, Y), u = [], v = [], X = [], Y = []); else if (!r) {
                ...
                case "column":
                    oa = sa;
                    void 0 != y.lineColor && (oa = y.lineColor);
                    if (!isNaN(Z)) {
                        Z < ma ? (y.isNegative = !0, Oa && (Ca = Oa), void 0 != Da && (oa = Da)) : y.isNegative = !1;
                        var Bb = f.min, Cb = f.max;
                        if (!(Z < Bb && na < Bb || Z > Cb && na > Cb))if (n) {
                            "3d" == B ? (R = C - 0.5 * (h + E) + E / 2 + K * S, Q = N + I * S) : (R = Math.floor(C - (s / 2 - S) * (h + E) + E / 2), Q = N);
                            O = h;
                            ba = D;
                            fa = R + h / 2;
                            ja = D;
                            ...
                            aa = D - N;
                            var Pb = Q;
                            Q = AmCharts.fitToBounds(Q, 0, l);
                            aa += Pb - Q;
                            aa = AmCharts.fitToBounds(aa, -Q, l - Q + I *
                                S);
                            if (R < m && 0 < O && (qa = new AmCharts.Cuboid(e, aa, O, I - a.d3x, K - a.d3y, Ca, Ra, V, oa, $, G, q, n, P, Sa), "bottom" != J && "inside" != J && "middle" != J))if (J = f.reversed ? "left" : "right", 0 > Z)J = f.reversed ? "right" : "left"; else if ("regular" == B || "100%" == B)ba += this.dx
                        } else {
                            "3d" == B ? (Q = D - 0.5 * (h + E) + E / 2 + I * S, R = L + K * S) : (Q = D - (s / 2 - S) * (h + E) + E / 2, R = L);
                            O = h;
                            ba = Q + h / 2;
                            fa = C;
                            ja = Q + h / 2;
                            ...
                            aa = C - L;
                            var Qb = R;
                            R = AmCharts.fitToBounds(R, this.dy, m);
                            aa += Qb - R;
                            aa = AmCharts.fitToBounds(aa, -R + K * S, m - R);
                            if (Q < l + S * I && 0 < O)if (qa = new AmCharts.Cuboid(e,
                                O, aa, I - a.d3x, K - a.d3y, Ca, Ra, V, oa, this.lineAlpha, G, q, n, P, Sa), 0 > Z && "middle" != J && "inside" != J)J = "bottom"; else if (J = pa, "regular" == B || "100%" == B)fa += this.dy
                        }
                        if (qa && (ta = qa.set, ta.translate(Q, R), this.columnsSet.push(ta), (y.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), !U)) {
                            "none" == B && (A = n ? (this.end + 1 - H) * z - c : z * H + c);
                            "3d" == B && (n ? (A = (z - c) * (this.end + 1 - H), ba += I * this.columnIndex, ja += I * this.columnIndex, y.y += I * this.columnIndex) : (A = (z - c) * (H + 1), ba += 3, fa += K * this.columnIndex + 7, ka += K * this.columnIndex, y.y += K *
                                this.columnIndex));
                            if ("regular" == B || "100%" == B)"inside" != J && (J = "middle"), A = n ? 0 < ua.value ? (this.end + 1 - H) * z + c : (this.end + 1 - H) * z - c : 0 < ua.value ? z * H + c : z * H - c;
                            this.columnsArray.push({column: qa, depth: A});
                            y.x = n ? R + O / 2 : Q + O / 2;
                            this.ownColumns.push(qa);
                            this.animateColumns(qa, H, D, N, C, L);
                            this.addListeners(ta, y)
                        }
                    }
                    break;
                case "candlestick":
                    if (!isNaN(na) && !isNaN(Z)) {
                        ...
                        void 0 != y.lineColor && (oa = y.lineColor);
                        if (n) {
                            if (R = C - h / 2, Q = N, O = h, R + O > m && (O = m - R), 0 > R && (O += R, R = 0), R < m && 0 < O) {
                                var nb, ob;
                                Z > na ? (nb = [D, Ja], ob = [N, Ia]) :
                                    (nb = [N, Ja], ob = [D, Ia]);
                                !isNaN(Ja) && !isNaN(Ia) && C < m && 0 < C && (db = AmCharts.line(e, nb, [C, C], oa, $, V), mb = AmCharts.line(e, ob, [C, C], oa, $, V));
                                aa = D - N;
                                qa = new AmCharts.Cuboid(e, aa, O, I, K, Ca, Pa, V, oa, $, G, q, n, P, Sa)
                            }
                        } else if (Q = D - h / 2, R = L + V / 2, O = h, Q + O > l && (O = l - Q), 0 > Q && (O += Q, Q = 0), aa = C - L, Q < l && 0 < O) {
                            var qa = new AmCharts.Cuboid(e, O, aa, I, K, Ca, Ra, V, oa, $, G, q, n, P, Sa), pb, qb;
                            Z > na ? (pb = [C, Ba], qb = [L, Aa]) : (pb = [L, Ba], qb = [C, Aa]);
                            !isNaN(Ba) && !isNaN(Aa) && D < l && 0 < D && (db = AmCharts.line(e, [D, D], pb, oa, $, V), mb = AmCharts.line(e, [D, D], qb, oa, $, V))
                        }
                        qa &&
                        (ta = qa.set, W.push(ta), ta.translate(Q, R - V / 2), (y.url || this.showHandOnHover) && ta.setAttr("cursor", "pointer"), db && (W.push(db), W.push(mb)), ba = D, fa = C, n ? (ka = C, ja = D, "open" == k && (ja = N), "high" == k && (ja = Ja), "low" == k && (ja = Ia)) : (ka = C, "open" == k && (ka = L), "high" == k && (ka = Ba), "low" == k && (ka = Aa), ja = D), U || (y.x = n ? R + O / 2 : Q + O / 2, this.animateColumns(qa, H, D, N, C, L), this.addListeners(ta, y)))
                    }
                    break;
                case "ohlc":
                    if (!(isNaN(na) || isNaN(jb) || isNaN(kb) || isNaN(Z))) {
                        Z < na && (y.isNegative = !0, void 0 != Da && (sa = Da));
                        var rb, sb, tb;
                        if (n) {
                            var ub = C -
                                h / 2, ub = AmCharts.fitToBounds(ub, 0, m), Db = AmCharts.fitToBounds(C, 0, m), vb = C + h / 2, vb = AmCharts.fitToBounds(vb, 0, m);
                            sb = AmCharts.line(e, [N, N], [ub, Db], sa, $, V, P);
                            0 < C && C < m && (rb = AmCharts.line(e, [Ia, Ja], [C, C], sa, $, V, P));
                            tb = AmCharts.line(e, [D, D], [Db, vb], sa, $, V, P)
                        } else {
                            var wb = D - h / 2, wb = AmCharts.fitToBounds(wb, 0, l), Eb = AmCharts.fitToBounds(D, 0, l), xb = D + h / 2, xb = AmCharts.fitToBounds(xb, 0, l);
                            sb = AmCharts.line(e, [wb, Eb], [L, L], sa, $, V, P);
                            0 < D && D < l && (rb = AmCharts.line(e, [D, D], [Aa, Ba], sa, $, V, P));
                            tb = AmCharts.line(e, [Eb, xb], [C, C],
                                sa, $, V, P)
                        }
                        W.push(sb);
                        W.push(rb);
            ...
            if (!U && !isNaN(Z)) {
                ...
                if (this.end - this.start <= Fb || 0 === Fb) {
                    var Fa = this.createBullet(y, ja, ka, H);
                    Fa || (Fa = 0);
                    var Gb = this.labelText;
                    if (Gb) {
                        var ea = this.createLabel(y, 0, 0, Gb), wa = 0, xa = 0, Hb = ea.getBBox(), La = Hb.width, Ga = Hb.height;
                        switch (J) {
                            case "left":
                                wa = -(La / 2 + Fa / 2 + 3);
                                break;
                            ...
                            case "right":
                                ...
                                break;
                            case "bottom":
                                n && "column" == g ? (ba = ga, 0 > Z || 0 < Z && f.reversed ? (wa = -6, ea.attr({"text-anchor": "end"})) :
                                    (wa = 6, ea.attr({"text-anchor": "start"}))) : (xa = Fa / 2 + Ga / 2, ea.x = -(La / 2 + 2));
                                break;
                            case "middle":
                                "column" == g && (n ? (xa = -(Ga / 2) + this.fontSize / 2, wa = -(D - N) / 2 - I, 0 > aa && (wa += I), Math.abs(D - N) < La && !this.showAllValueLabels && (ea.remove(), ea = null)) : (xa = -(C - L) / 2, 0 > aa && (xa -= K), Math.abs(C - L) < Ga && !this.showAllValueLabels && (ea.remove(), ea = null)));
                                break;
                            case "inside":
                    ...
                    if ("regular" == B || "100%" == B) {
                        var Jb = f.totalText;
                        if (Jb) {
                            var Ma = this.createLabel(y, 0, 0, Jb, f.totalTextColor);
                            this.allBullets.push(Ma);
                            var Kb = Ma.getBBox(), Lb = Kb.width, Mb = Kb.height, Ta, Ua, Nb = f.totals[H];
                            Nb && Nb.remove();
                            var Va = 0;
                            "column" != g && (Va = Fa);
    ...
    if (1 < a.length) {
        var f =
            e.set, g = e.container, h = g.set(), k = g.set();
        f.push(k);
        f.push(h);
        var l = e.lineAlpha, m = e.lineThickness, f = e.fillAlphas, p = e.lineColorR, n = e.negativeLineAlpha;
        isNaN(n) && (n = l);
        var s = e.lineColorSwitched;
        s && (p = s);
        var s = e.fillColorsR, q = e.fillColorsSwitched;
        q && (s = q);
        var r = e.dashLength;
        (q = e.dashLengthSwitched) && (r = q);
        var q = e.negativeLineColor, u = e.negativeFillColors, v = e.negativeFillAlphas, t = e.baseCoord;
        ...
        void 0 !== q && (m = AmCharts.line(g, a, b, q, n, m, r, !1, !0), k.push(m));
        if (0 < f || 0 < v)if (m = a.join(";").split(";"), n = b.join(";").split(";"), "serial" == e.chart.type && (0 < c.length ? (c.reverse(), d.reverse(), m = a.concat(c), n = b.concat(d)) : e.rotate ? (n.push(n[n.length - 1]), m.push(t), n.push(n[0]), m.push(t), n.push(n[0]), m.push(m[0])) : (m.push(m[m.length -
            1]), n.push(t), m.push(m[0]), n.push(t), m.push(a[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (b = AmCharts.polygon(g, m, n, s, f, 1, "#000", 0, a), b.pattern(e.pattern), h.push(b)), u || void 0 !== q)isNaN(v) && (v = f), u || (u = q), g = AmCharts.polygon(g, m, n, u, v, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g), k.click(function (a) {
            e.handleGraphEvent(a, "clickGraph")
        }).mouseover(function (a) {
            e.handleGraphEvent(a, "rollOverGraph")
        }).mouseout(function (a) {
    ...
    if (1 < a.length) {
        ...
        e.push(h);
        e.push(g);
        var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, p = this.lineColorR, n = this.fillColorsR, s = this.negativeLineColor, q = this.negativeFillColors, r = this.negativeFillAlphas, u = this.baseCoord, v = this.lineColorSwitched;
        v && (p = v);
        (v = this.fillColorsSwitched) && (n =
            v);
        v = this.negativeLineAlpha;
        isNaN(v) && (v = k);
        k = new AmCharts.Bezier(f, a, b, p, k, l, n, 0, e);
        g.push(k.path);
        void 0 !== s && (l = new AmCharts.Bezier(f, a, b, s, v, l, n, 0, e), h.push(l.path));
        0 < m && (k = a.join(";").split(";"), p = b.join(";").split(";"), l = "", 0 < c.length ? (c.push("M"), d.push("M"), c.reverse(), d.reverse(), k = a.concat(c), p = b.concat(d)) : (this.rotate ? (l += " L" + u + "," + b[b.length - 1], l += " L" + u + "," + b[0]) : (l += " L" + a[a.length - 1] + "," + u, l += " L" + a[0] + "," + u), l += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, k, p, NaN, 0, 0, n, m, e, l), c.path.pattern(this.pattern),
            g.push(c.path), q || void 0 !== s) && (r || (r = m), q || (q = s), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, q, r, e, l), a.path.pattern(this.pattern), h.push(a.path));
        this.applyMask(h, g)
    }
    ...
    var a =
        this.chart, b = this.set, c = this.bulletSet, d = this.x, e = this.y;
    b.show();
    c.show();
    ...
    var g = a.values.value,
        h = this.maxValue, k = this.minValue, l = this.maxBulletSize, m = this.minBulletSize;
    ...
    (m = this.bulletColorNegative);
    void 0 !== a.color && (m = a.color);
    var n;
    "xy" == this.chart.type && this.valueField && (n = this.pattern, a.pattern && (n = a.pattern));
    e = this.bullet;
    a.bullet && (e = a.bullet);
    var g = this.bulletBorderThickness, k = this.bulletBorderColorR, l = this.bulletBorderAlpha, s = this.bulletAlpha;
    k || (k = m);
    this.useLineColorForBulletBorder && (k = this.lineColorR);
    var q = a.alpha;
    isNaN(q) || (s = q);
    if ("none" != this.bullet || a.bullet)p = AmCharts.bullet(d, e, f, m, s, g, k, l, h, 0, n);
    if (this.customBullet || a.customBullet)n = this.customBullet,
        a.customBullet && (n = a.customBullet), n && (p && p.remove(), "function" == typeof n ? (p = new n, p.chart = this.chart, a.bulletConfig && (p.availableSpace = c, p.graph = this, a.bulletConfig.minCoord = this.minCoord - c, p.bulletConfig = a.bulletConfig), p.write(d), p = p.set) : (this.chart.path && (n = this.chart.path + n), p = d.set(), d = d.image(n, 0, 0, f, f), p.push(d), this.centerCustomBullets && d.translate(-f / 2, -f / 2)));
    p && ((a.url || this.showHandOnHover) && p.setAttr("cursor", "pointer"), "serial" == this.chart.type && (0 > b - 0 || b - 0 > this.width || c < -f / 2 || c - 0 >
        this.height) && (p.remove(), p = null), p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p)), a.bx = b, a.by = c);
    a.bulletGraphics = p;
    return f
    ...
    this.chart.hideBalloon();
    if (a) {
        var c = {type: "rollOutGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart, event: b};
...
AmCharts.ChartCursor = AmCharts.Class({construct: function (a) {
    ...
    var a = this.chart, b = this.cursorAlpha, c = a.categoryAxis, d = c.position, e = c.inside, f = c.axisThickness, g = this.categoryBalloon, h, k, l = a.dx, m = a.dy, p = this.x, n = this.y, s = this.width, q = this.height, a = a.rotate, r = c.tickLength;
    g.pointerWidth = r;
    a ? (h = [0, s, s + l], k = [0, 0, m]) : (h = [l, 0, 0], k = [m, 0, q]);
    this.line = b = AmCharts.line(this.container,
        h, k, this.cursorColor, b, 1);
    (h = this.fullRectSet) ? (h.push(b), h.translate(this.x, this.y)) : this.set.push(b);
    a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(p, n + m, p + s + l, n + q + m) : g.setBounds(p + s + l + f, n + m, p + s + 1E3, n + q + m) : e ? g.setBounds(p, n, s + p, q + n) : g.setBounds(-1E3, -1E3, p - r - f, n + q + 15)) : (g.maxWidth = s, c.parseDates && (r = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(p + l, n + m, s + l + p, q + n) : g.setBounds(p + l, -1E3, s + l + p, n + m - r - f) : e ? g.setBounds(p, n, s + p, q + n - r) : g.setBounds(p, n + q + r + f - 1, p + s, n + q + r + f));
    this.hideCursor()
}, createCrosshair: function () {
    var a =
        this.cursorAlpha, b = this.container, c = AmCharts.line(b, [0, 0], [0, this.height], this.cursorColor, a, 1), a = AmCharts.line(b, [0, this.width], [0, 0], this.cursorColor, a, 1);
    this.set.push(c);
    this.set.push(a);
    this.vLine = c;
    this.hLine = a;
    ...
    var a = this.chart, b = a.mouseX - this.x, c = a.mouseY - this.y, d = this.vLine, e = this.hLine, b = AmCharts.fitToBounds(b, 0, this.width), c = AmCharts.fitToBounds(c, 0,
        this.height);
    ...
    var c = this.selectionPosX,
        d = this.selectionPosY, e = 0, f = 0, g = this.width, h = this.height;
    ...
    for (e = 0; e < f; e++) {
        ...
        0 < e && b - h < d + 3 && (g.setBounds(c, d + 3, c + this.width, d + h + 3), g.prevX = this.prevX[k],
    ...
    zoom: function (a, b, c, d) {
        ...
        c = this.height;
        a = d.stepWidth;
        this.fullWidth && (f = 1, d.parseDates && !d.equalSpacing && (f = d.minDuration()), e ? this.extraWidth = c = a * f : (this.extraWidth = b = a * f, this.categoryBalloon.minWidth = b), this.line && this.line.remove(), this.line = AmCharts.rect(this.container,
            b, c, this.cursorColor, this.cursorAlpha, 0), this.fullRectSet && this.fullRectSet.push(this.line));
        this.stepWidth = a;
        ...
        this.drawingNow && (AmCharts.remove(this.drawingLine), this.drawingLine =
            AmCharts.line(this.container, [this.x + this.drawStartX, this.x + e], [this.y + this.drawStartY, this.y + f], this.cursorColor, 1, 1));
        if (this.enabled) {
            void 0 === b && (b = !0);
            this.index = a += this.adjustment;
            var g = c.categoryAxis, h = c.dx, k = c.dy, l = this.x + 1, m = this.y + 1, p = this.width, n = this.height, s = this.data[a];
            this.fireMoved();
            if (s) {
                var q = s.x[g.id], r = c.rotate, u = g.inside, v = this.stepWidth, t = this.categoryBalloon, w = this.firstTime, x = this.lastTime, F = this.cursorPosition, z = g.position, A = this.zooming, I = this.panning, K = c.graphs, B = g.axisThickness;
                if (c.mouseIsOver || A || I || this.forceShow)if (this.forceShow = !1, I) {
                    var h = this.panClickPos, c = this.panClickEndTime, A = this.panClickStartTime, J = this.panClickEnd, l = this.panClickStart, e = (r ? h - f : h - e) / v;
                    if (!g.parseDates || g.equalSpacing)e = Math.round(e);
                    0 !== e && (h = {type: "zoomed", target: this}, h.chart = this.chart, g.parseDates && !g.equalSpacing ? (c + e > x && (e = x - c), A + e < w && (e = w - A), h.start = A + e, h.end = c + e, this.fire(h.type, h)) : J + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = J + e, this.fire(h.type, h)))
                } else {
                    "start" == F ? q -= g.cellWidth /
                        2 : "mouse" == F && c.mouseIsOver && (q = r ? f - 2 : e - 2);
                    if (r) {
                        if (0 > q)if (A)q = 0; else {
                            this.hideCursor();
                            return
                        }
                        if (q > n + 1)if (A)q = n + 1; else {
                            this.hideCursor();
                            return
                        }
                    } else {
                    ...
                    if (0 < this.cursorAlpha) {
                        var M = this.line;
                        r ? (w = 0, x = q + k, d && (x -= g.cellWidth / 2)) : (w = q, x = 0, d && (w -= g.cellWidth / 2));
                        v = this.animationDuration;
                        0 < v && !this.zooming ? isNaN(this.previousX) ? M.translate(w, x) : (M.translate(this.previousX, this.previousY), M.animate({translate: w +
                            "," + x}, v, "easeOutSine")) : M.translate(w, x);
                        this.previousX = w;
                        this.previousY = x;
                        M.show()
                    }
                    this.linePos = r ? q + k : q;
                    A && (d && M.hide(), r ? this.updateSelectionSize(NaN, q) : this.updateSelectionSize(q, NaN));
                    v = !0;
                    A && (v = !1);
                    this.categoryBalloonEnabled && v ? (r ? (u && ("right" == z ? t.setBounds(l, m + k, l + p + h, m + q + k) : t.setBounds(l, m + k, l + p + h, m + q)), "right" == z ? u ? t.setPosition(l + p + h, m + q + k) : t.setPosition(l + p + h + B, m + q + k) : u ? t.setPosition(l, m + q) : t.setPosition(l - B, m + q)) : "top" == z ? u ? t.setPosition(l + q + h, m + k) : t.setPosition(l + q + h, m + k - B + 1) : u ? t.setPosition(l +
                        q, m + n) : t.setPosition(l + q, m + n + B - 1), (w = this.categoryBalloonFunction) ? t.showBalloon(w(s.category)) : g.parseDates ? (g = AmCharts.formatDate(s.category, this.categoryBalloonDateFormat), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, s.category)), t.showBalloon(g)) : t.showBalloon(AmCharts.fixNewLines(s.category))) : t.hide();
                    K && this.bulletsEnabled && this.showBullets();
                    if (this.oneBalloonOnly) {
                        k = Infinity;
                        for (t = 0; t < K.length; t++)g = K[t], g.showBalloon && !g.hidden && g.balloonText && (w = s.axes[g.valueAxis.id].graphs[g.id],
                            x = w.y, isNaN(x) || (r ? Math.abs(e - x) < k && (k = Math.abs(e - x), J = g) : Math.abs(f - x) < k && (k = Math.abs(f - x), J = g)));
                        this.mostCloseGraph && (J = this.mostCloseGraph)
                    }
                    if (a != this.previousIndex || J != this.previousMostCloseGraph)if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], K && this.valueBalloonsEnabled && v && c.balloon.enabled) {
                        this.valueBalloons = v = [];
                        for (t = 0; t < K.length; t++)if (g = K[t], (!this.oneBalloonOnly || g == J) && g.showBalloon && !g.hidden && g.balloonText && ("step" == g.type && "left" == g.stepDirection &&
                            (s = this.data[a + 1]), s)) {
                            w = s.axes[g.valueAxis.id].graphs[g.id];
                            x = w.y;
                            if (this.showNextAvailable && isNaN(x) && a + 1 < this.data.length)for (k = a + 1; k < this.data.length; k++)if (q = this.data[k])if (w = q.axes[g.valueAxis.id].graphs[g.id], x = w.y, !isNaN(x))break;
                            if (!isNaN(x)) {
                                q = w.x;
                                u = !0;
                                if (r) {
                                    if (k = x, 0 > q || q > n)u = !1
                                } else if (k = q, q = x, 0 > k || k > p + h + 1)u = !1;
                                u && (1 != this.graphBulletSize && AmCharts.isModern && (u = w.bulletGraphics) && (u.getBBox(), u.translate(w.bx, w.by, this.graphBulletSize), this.resizedBullets.push(w)), u = g.valueBalloon, z = c.getBalloonColor(g,
                                    w), u.setBounds(l, m, l + p, m + n), u.pointerOrientation = "H", u.changeColor(z), void 0 !== g.balloonAlpha && (u.fillAlpha = g.balloonAlpha), void 0 !== g.balloonTextColor && (u.color = g.balloonTextColor), u.setPosition(k + l, q + m), k = c.formatString(g.balloonText, w, !0), (q = g.balloonFunction) && (k = q(w, g).toString()), "" !== k && (r ? u.showBalloon(k) : (u.text = k, u.show = !0)), !r && u.set && u.set.hide(), v.push({yy: x, balloon: u}))
                            }
                        }
                        r || this.arrangeBalloons()
                    }
                    b ? (h = {type: "changed"}, h.index = a, h.chart = this.chart, h.zooming = A, h.mostCloseGraph = J, h.position =
                        r ? f : e, h.target = this, c.fire("changed", h), this.fire("changed", h), this.skipZoomDispatch = !1) : (this.skipZoomDispatch = !0, c.updateLegendValues(a));
        ...
        if (a) {
            ...
            if (this.drawingNow) {
                ...
                if (2 < Math.abs(c - d) || 2 < Math.abs(f - e))c = {type: "draw", target: this, chart: a, initialX: c, initialY: f, finalX: d,
                    finalY: e}, this.fire(c.type, c)
            }
            if (this.enabled && 0 < b.length) {
                if (this.pan)this.rolledOver = !1; else if (this.zoomable && this.zooming) {
                    ...
                    c.target = this;
                    c.chart = a;
                    if ("cursor" == this.type)this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d, 2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end = this.fromIndex, c.start = this.index) : (c.end = this.index, c.start = this.fromIndex), e = a.categoryAxis, e.parseDates && !e.equalSpacing &&
                        (c.start = b[c.start].time, c.end = a.getEndTime(b[c.end].time)), this.skipZoomDispatch || this.fire(c.type, c)); else {
                ...
                this.panning =
                    this.zooming = this.skipZoomDispatch = !1
            }
        }
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ?
                ...
                d, this.selectionPosY = e), this.zooming = !0)
        }
    }});
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct: function (a) {
    ...
    c = h.x + e;
    d = h.y + f;
    var k = h.width, h = h.height, l = this.rotate, m = this.chart, p = this.width, n = this.height, s = m.mouseX, q = m.mouseY;
    a = this.initialMouse;
    m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (q - a), 0 > a && (a = 0), m = n - h, a > m && (a = m), g.setAttr("y", a)) : (a = m + (s - a), 0 > a && (a = 0), m = p - k, a > m && (a = m), g.setAttr("x", a))), this.resizingRight &&
    ...
    var a = this.getDBox(), b =
        a.x, c = a.y, d = this.iconLeft, e = this.iconRight, f, g, h = this.scrollbarHeight;
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function (a) {
    ...
    if (l = a.graph) {
        ...
        p.axisAlpha = 0;
        m.push(p.set);
        e ? (p.y = g, p.x = 0) : (p.x = f, p.y = 0);
        var f = Infinity, g = -Infinity, s;
        for (s = 0; s < c.length; s++) {
            var q = c[s].axes[n.id].graphs[l.id].values, r;
        ...
        -Infinity != g && (p.maximum = g + 0.1 * (g - f));
        f == g && (p.minimum -= 1, p.maximum += 1);
    ...
    if (this.skipEvent)this.skipEvent = !1; else {
        ...
        e.chart = d;
        var f = this.categoryAxis, g = this.stepWidth;
        ...
        } else if (f.startOnAxis || (b += g / 2), c -= this.stepWidth / 2, d = f.xToIndex(b), b = f.xToIndex(b + c), d != this.start || this.end != b)f.startOnAxis &&
            (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d-- : b = 1)), this.start = d, this.end = this.dragging ? this.start + this.difference : b, e.start = this.start, e.end = this.end, f.parseDates && (a[this.start] && (e.startDate = new Date(a[this.start].time)), a[this.end] && (e.endDate = new Date(a[this.end].time))), this.fire(e.type, e)
    }
...
AmCharts.AmBalloon = AmCharts.Class({construct: function (a) {
    ...
    if (!isNaN(a)) {
        ...
        if (this.show) {
            var g = this.l, h = this.t, k = this.r, l = this.b, m = this.balloonColor, p = this.fillColor, n = this.borderColor, s = p;
            void 0 != m && (this.adjustBorderColor ? s = n = m : p = m);
            var q = this.horizontalPadding, r = this.verticalPadding, u = this.pointerWidth, v = this.pointerOrientation, t = this.cornerRadius, w = c.fontFamily, x = this.fontSize;
            void 0 == x && (x = c.fontSize);
            var m = document.createElement("div"), F = m.style;
            F.position = "absolute";
            var z = this.minWidth, A = "";
            isNaN(z) || (A = "min-width:" + (z - 2 * q) + "px; ");
            m.innerHTML =
                '<div style="text-align:center; ' + A + "max-width:" + this.maxWidth + "px; font-size:" + x + "px; color:" + this.color + "; font-family:" + w + '">' + this.text + "</div>";
            c.chartDiv.appendChild(m);
            this.textDiv = m;
            x = m.offsetWidth;
            w = m.offsetHeight;
            m.clientHeight && (x = m.clientWidth, w = m.clientHeight);
            w += 2 * r;
            A = x + 2 * q;
            !isNaN(z) && A < z && (A = z);
            window.opera && (w += 2);
            ...
            "H" != v ? (z = a - A / 2, b < h + w + 10 && "down" != v ? (I = !0, d && (b += x), x = b + u, this.deltaSignY = -1) : (d && (b -= x), x = b - w - u, this.deltaSignY =
                1)) : (2 * u > w && (u = w / 2), x = b - w / 2, a < g + (k - g) / 2 ? (z = a + u, this.deltaSignX = -1) : (z = a - A - u, this.deltaSignX = 1));
            x + w >= l && (x = l - w);
            x < h && (x = h);
            z < g && (z = g);
            z + A > k && (z = k - A);
            var h = x + r, l = z + q, r = this.shadowAlpha, K = this.shadowColor, q = this.borderThickness, B = this.bulletSize, J;
            0 < t || 0 === u ? (0 < r && (a = AmCharts.rect(e, A, w, p, 0, q + 1, K, r, this.cornerRadius), AmCharts.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p = AmCharts.rect(e, A, w, p, this.fillAlpha, q, n, this.borderAlpha, this.cornerRadius), this.showBullet && (J = AmCharts.circle(e, B, s,
                this.fillAlpha), f.push(J))) : (s = [], t = [], "H" != v ? (g = a - z, g > A - u && (g = A - u), g < u && (g = u), s = [0, g - u, a - z, g + u, A, A, 0, 0], t = I ? [0, 0, b - x, 0, 0, w, w, 0] : [w, w, b - x, w, w, 0, 0, w]) : (s = b - x, s > w - u && (s = w - u), s < u && (s = u), t = [0, s - u, b - x, s + u, w, w, 0, 0], s = a < g + (k - g) / 2 ? [0, 0, z < a ? 0 : a - z, 0, 0, A, A, 0] : [A, A, z + A > a ? A : a - z, A, A, 0, 0, A]), 0 < r && (a = AmCharts.polygon(e, s, t, p, 0, q, K, r), a.translate(1, 1), f.push(a)), p = AmCharts.polygon(e, s, t, p, this.fillAlpha, q, n, this.borderAlpha));
            this.bg = p;
            f.push(p);
            p.toFront();
            e = 1 * this.deltaSignX;
            ...
            this.bottom = x + w + 1;
            this.yPos = p.y + x;
            J && J.translate(this.pointToX - z + e, b - x);
            b = this.animationDuration;
            0 < this.animationDuration && !d && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY), f.animate({translate: z - e + "," + x}, b, "easeOutSine"), m && (F.left = this.prevTX + "px", F.top = this.prevTY + "px", this.xAnim = c.animate({node: m}, "left", this.prevTX, l, b, "easeOutSine", "px"), this.yAnim = c.animate({node: m}, "top", this.prevTY, h, b, "easeOutSine", "px")));
            this.prevX = z - e;
            this.prevY = x;
            this.prevTX = l;
            this.prevTY =
    ...
    (b.follow = a) ? (b.pShowBullet = b.showBullet, b.showBullet = !1) : void 0 !==
        b.pShowBullet && (b.showBullet = b.pShowBullet);
...
AmCharts.AmCoordinateChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
    ...
    createValueAxes: function () {
        ...
        if (e) {
            var f = !1, g, h = this.categoryAxis, k;
            ...
            this.lookupTable =
                p;
            var n, s = this.dataDateFormat;
            for (n = 0; n < e.length; n++) {
                var q = {}, r = e[n];
                b = r[this.categoryField];
                q.dataContext = r;
                q.category = g ? g(b, r, h) : String(b);
                k && (q.forceShow = r[k]);
                p[r[d]] = q;
                f && (b = h.categoryFunction ? h.categoryFunction(b, r, h) : b instanceof Date ? "fff" == h.minPeriod ? AmCharts.useUTC ? new Date(b.getUTCFullYear(), b.getUTCMonth(), b.getUTCDate(), b.getUTCHours(), b.getUTCMinutes(), b.getUTCSeconds(), b.getUTCMilliseconds()) : new Date(b.getFullYear(), b.getMonth(), b.getDate(), b.getHours(), b.getMinutes(), b.getSeconds(),
                    b.getMilliseconds()) : new Date(b) : s ? AmCharts.stringToDate(b, s) : new Date(b), b = AmCharts.resetDateToMin(b, l, m, h.firstDayOfWeek), q.category = b, q.time = b.getTime());
                ...
                for (v = 0; v < u.length; v++) {
                    ...
                    for (w = 0; w < a.length; w++) {
                        ...
                        if (b.valueAxis.id == t) {
                            ...
                            var A = r;
                            b.dataProvider && (A = c);
                            z.values = this.processValues(A, b, F);
                            this.processFields(b, z, A);
                            z.category =
                                q.category;
                            z.serialDataItem = q;
                            z.graph = b;
...
AmCharts.AmSlicedChart = AmCharts.Class({inherits: AmCharts.AmChart, construct: function (a) {
    ...
    if (!a.hidden) {
        ...
        var f = this.formatString(this.balloonText, a, !0), g = AmCharts.adjustLuminosity(a.color,
            -0.15);
    ...
    if (void 0 !== b) {
        ...
        for (e = 0; e < c; e++) {
            ...
            f.title = g;
            f.pulled = AmCharts.toBoolean(h[this.pulledField],
                !1);
        ...
        for (e = b = 0; e < c; e++)f =
            a[e], f.percents = f.value / d * 100, f.percents < this.groupPercent && b++;
        ...
        for (e = 0; e < a.length; e++)c ? g = AmCharts.adjustLuminosity(c,
            e * d / 100) : (g = this.colors[e], void 0 === g && (g = AmCharts.randomColor())), void 0 === a[e].color && (a[e].color = g);
        this.recalculatePercents()
    }
...
AmCharts.AmRectangularChart = AmCharts.Class({inherits: AmCharts.AmCoordinateChart, construct: function (a) {
    ...
    var c = a.color, d = a.fontSize, e = a.zoomOutButtonImageSize, f = a.zoomOutButtonImage, g = a.zoomOutText, h = a.zoomOutButtonColor, k = a.zoomOutButtonAlpha, l = a.zoomOutButtonFontSize, m = a.zoomOutButtonPadding;
    isNaN(l) || (d = l);
    ...
    var n = l = 0;
    void 0 !== a.pathToImages && f && (p = a.container.image(a.pathToImages + f, 0, 0, e, e), b.push(p), p = p.getBBox(), l = p.width + 5);
    ...
    clickZB: function () {
        ...
        var a = this.valueAxes, b = this.marginLeftReal, c = this.marginTopReal, d = this.plotAreaHeight, e = this.plotAreaWidth, f;
...
AmCharts.TrendLine = AmCharts.Class({construct: function (a) {
    ...
    var a = this;
    a.destroy();
    var b = a.chart, c = b.container, d, e, f, g, h = a.categoryAxis, k = a.initialDate, l = a.initialCategory, m = a.finalDate, p = a.finalCategory, n = a.valueAxis, s = a.valueAxisX, q = a.initialXValue, r = a.finalXValue, u = a.initialValue, v = a.finalValue,
        t = n.recalculateToPercents, w = b.dataDateFormat;
    h && (k && (k instanceof Date || (k = w ? AmCharts.stringToDate(k, w) : new Date(k)), a.initialDate = k, d = h.dateToCoordinate(k)), l && (d = h.categoryToCoordinate(l)), m && (m instanceof Date || (m = w ? AmCharts.stringToDate(m, w) : new Date(m)), a.finalDate = m, e = h.dateToCoordinate(m)), p && (e = h.categoryToCoordinate(p)));
    s && !t && (isNaN(q) || (d = s.getCoordinate(q)), isNaN(r) || (e = s.getCoordinate(r)));
    n && !t && (isNaN(u) || (f = n.getCoordinate(u)), isNaN(v) || (g = n.getCoordinate(v)));
    isNaN(d) || isNaN(e) ||
...
AmCharts.polygon = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    void 0 === g && (g = p);
    e = {fill: p, stroke: g, "fill-opacity": e, "stroke-width": f, "stroke-opacity": h};
...
AmCharts.rect = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    s += AmCharts.dx;
    q += AmCharts.dy;
    e = {fill: p, stroke: g, "fill-opacity": e, "stroke-opacity": h};
    void 0 !== m && 0 < m && (e["stroke-dasharray"] = m);
...
AmCharts.bullet = function (a, b, c, d, e, f, g, h, k, l, m) {
    ...
    switch (b) {
        case "round":
            p = AmCharts.circle(a, c / 2, d, e, f, g, h);
            break;
        case "square":
            p = AmCharts.polygon(a, [-c / 2, c / 2, c / 2, -c / 2], [c / 2, c / 2, -c / 2, -c / 2], d, e, f, g, h, l - 180);
            break;
        case "rectangle":
            p = AmCharts.polygon(a, [-c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], d, e, f, g, h, l - 180);
            break;
        case "diamond":
            p = AmCharts.polygon(a, [-c / 2, 0, c / 2, 0], [0, -c / 2, 0, c / 2], d, e, f, g, h);
            break;
        case "triangleUp":
            p = AmCharts.triangle(a, c, 0, d, e, f, g, h);
            break;
        case "triangleDown":
            ...
            break;
        case "triangleLeft":
            p = AmCharts.triangle(a, c, 270, d, e, f, g, h);
            break;
        case "triangleRight":
            p = AmCharts.triangle(a, c, 90, d, e, f, g, h);
            break;
        case "bubble":
            p = AmCharts.circle(a, c / 2, d, e, f, g, h, !0);
            break;
        case "line":
            p = AmCharts.line(a, [-c / 2, c / 2], [0, 0], d, e, f, g, h);
            break;
        case "yError":
            p = a.set();
            p.push(AmCharts.line(a, [0, 0], [-c / 2, c / 2], d, e, f));
            p.push(AmCharts.line(a, [-k, k], [-c / 2, -c / 2], d, e, f));
            p.push(AmCharts.line(a, [-k, k], [c / 2, c / 2], d, e, f));
            break;
        case "xError":
            p = a.set(), p.push(AmCharts.line(a, [-c /
                2, c / 2], [0, 0], d, e, f)), p.push(AmCharts.line(a, [-c / 2, -c / 2], [-k, k], d, e, f)), p.push(AmCharts.line(a, [c / 2, c / 2], [-k, k], d, e, f))
    }
    p && p.pattern(m);
    return p
};
...
AmCharts.makeHD = function (a, b, c) {
    for (var d = [], e = [], f = 1; f < a.length; f++)for (var g = Number(a[f - 1]), h = Number(b[f - 1]), k = Number(a[f]), l = Number(b[f]), m = Math.sqrt(Math.pow(k - g, 2) + Math.pow(l - h, 2)), m = Math.round(m / 50) + 1, k = (k - g) / m, l = (l - h) / m, p = 0; p <= m; p++) {
        var n = g + p * k + Math.random() * c, s = h + p * l + Math.random() * c;
        d.push(n);
        e.push(s)
    }
    return[d, e]
...
AmCharts.handDrawnLine = function (a, b, c, d, e, f, g, h, k, l, m) {
    var p = a.set();
    for (m = 1; m < b.length; m++)for (var n = [b[m - 1], b[m]], s = [c[m - 1], c[m]], s = AmCharts.makeHD(n, s, a.handDrawScatter), n = s[0], s = s[1], q = 1; q < n.length; q++)p.push(AmCharts.line(a, [n[q - 1], n[q]], [s[q - 1], s[q]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return p
};
AmCharts.doNothing = function (a) {
    return a
};
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, p) {
    var n = Math.round;
    f = n(f);
    g = n(g);
    h = n(h);
    var s = n(g / f * h), q = AmCharts.VML, r = 359.5 + f / 100;
    359.94 < r && (r = 359.94);
    e >= r && (e = r);
    var u = 1 / 180 * Math.PI, r = b + Math.sin(d * u) * h, v = c - Math.cos(d * u) * s, t = b + Math.sin(d * u) * f, w = c - Math.cos(d * u) * g, x = b + Math.sin((d + e) * u) * f, F = c - Math.cos((d + e) * u) * g, z = b + Math.sin((d + e) * u) * h, u = c - Math.cos((d + e) * u) * s, A = {fill: AmCharts.adjustLuminosity(l.fill, -0.2), "stroke-opacity": 0, "fill-opacity": l["fill-opacity"]}, I = 0;
    180 < Math.abs(e) && (I = 1);
    d = a.set();
    var K;
    q && (r = n(10 * r), t = n(10 * t), x = n(10 * x), z = n(10 * z), v = n(10 * v), w = n(10 * w), F = n(10 * F), u = n(10 * u), b = n(10 * b), k = n(10 * k), c = n(10 * c), f *= 10, g *= 10, h *= 10, s *= 10, 1 > Math.abs(e) && 1 >= Math.abs(x - t) && 1 >= Math.abs(F - w) && (K = !0));
    e = "";
    var B;
    p && (A["fill-opacity"] = 0, A["stroke-opacity"] = l["stroke-opacity"] / 2, A.stroke = l.stroke);
    0 < k && (q ? (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k), K || (B += " A" + (b - f) + "," + (k + c - g) + "," + (b + f) + "," + (k + c + g) + "," + t + "," + (w + k) + "," + x + "," + (F + k)), B += " L" + z + "," + (u + k), 0 < h && (K || (B += " B" + (b - h) + "," + (k + c - s) + "," + (b + h) + "," + (k + c + s) +
        "," + z + "," + (k + u) + "," + r + "," + (k + v)))) : (B = " M" + r + "," + (v + k) + " L" + t + "," + (w + k) + (" A" + f + "," + g + ",0," + I + ",1," + x + "," + (F + k) + " L" + z + "," + (u + k)), 0 < h && (B += " A" + h + "," + s + ",0," + I + ",0," + r + "," + (v + k))), B += " Z", B = a.path(B, void 0, void 0, "1000,1000").attr(A), d.push(B), B = a.path(" M" + r + "," + v + " L" + r + "," + (v + k) + " L" + t + "," + (w + k) + " L" + t + "," + w + " L" + r + "," + v + " Z", void 0, void 0, "1000,1000").attr(A), k = a.path(" M" + x + "," + F + " L" + x + "," + (F + k) + " L" + z + "," + (u + k) + " L" + z + "," + u + " L" + x + "," + F + " Z", void 0, void 0, "1000,1000").attr(A), d.push(B), d.push(k));
    q ? (K || (e = " A" + n(b - f) + "," + n(c - g) + "," + n(b + f) + "," + n(c + g) + "," + n(t) + "," + n(w) + "," + n(x) + "," + n(F)), f = " M" + n(r) + "," + n(v) + " L" + n(t) + "," + n(w) + e + " L" + n(z) + "," + n(u)) : f = " M" + r + "," + v + " L" + t + "," + w + (" A" + f + "," + g + ",0," + I + ",1," + x + "," + F) + " L" + z + "," + u;
    0 < h && (q ? K || (f += " B" + (b - h) + "," + (c - s) + "," + (b + h) + "," + (c + s) + "," + z + "," + u + "," + r + "," + v) : f += " A" + h + "," + s + ",0," + I + ",0," + r + "," + v);
...
AmCharts.Bezier = AmCharts.Class({construct: function (a, b, c, d, e, f, g, h, k, l) {
...
AmCharts.VMLRenderer = AmCharts.Class({construct: function (a, b) {
    ...
    for (e =
        ...
        "Z" == g && (a += " x e");
        if ("Q" == g) {
            var l = c.length, m = c[l - 1], p = h[0], n = h[1], k = h[2], s = h[3];
            c = d(c[l - 2] / 3 + 2 / 3 * p);
            m = d(m / 3 + 2 / 3 * n);
            p = d(2 / 3 * p + k / 3);
            n = d(2 / 3 * n + s / 3);
    ...
    if (0 !== Number(b)) {
        ...
        a.paddingLeft = 1;
        c = b * Math.PI / 180;
        var e = Math.cos(c), f = Math.sin(c), g = AmCharts.removePx(a.left), h = AmCharts.removePx(a.top),
...
AmCharts.AmLegend = AmCharts.Class({construct: function (a) {
    ...
    this.divWidth = k;
    this.container = new AmCharts.AmDraw(f, k, e, a);
    this.lx = 0;
    this.ly = 8;
    b = this.markerSize;
    ...
    var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, d = this.marginTop, e = this.marginBottom, f = this.horizontalGap, g = this.div, h = this.divWidth, k = this.maxColumns, l = this.verticalGap, m = this.spacing, p = h - c - b, n = 0, s = 0, q = this.container, r = q.set();
    this.set = r;
    q = q.set();
    r.push(q);
    ...
    for (t = 0; t < u.length; t++) {
        var z = u[t];
        this.reversedOrder && (z = u[u.length - t - 1]);
        v = z.getBBox();
        var A;
        this.equalWidths ? A = f + x * (n + m + this.markerLabelGap) : (A = F, F = F + v.width + f + m);
        A + v.width > p && 0 < t && 0 !== x && (w++, x = 0, A = f, F = A + v.width + f + m);
        z.translate(A, (s + l) * w);
        x++;
        !isNaN(k) && x >= k && (x = 0, w++);
        q.push(z)
    ...
    if (!1 !== a.visibleInLegend) {
        ...
        if (this.useGraphSettings)if (m = a.type, this.switchType = void 0, "line" == m || "step" == m || "smoothedLine" == m || "ohlc" == m)g = k.set(), a.hidden || (d = a.lineColorR, f = a.bulletBorderColorR), p = AmCharts.line(k, [0, 2 * l], [l / 2, l / 2], d, a.lineAlpha, a.lineThickness, a.dashLength), g.push(p), a.bullet && (a.hidden ||
            (d = a.bulletColorR), p = AmCharts.bullet(k, a.bullet, a.bulletSize, d, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (p.translate(l + 1, l / 2), g.push(p)), n = 0, m = l, p = l / 3; else {
            var s;
            a.getGradRotation && (s = a.getGradRotation());
            m = a.fillColorsR;
            !0 === a.hidden && (m = d);
            if (g = this.createMarker("rectangle", m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, s, g))n = l, g.translate(n, l / 2);
            m = l
        } else h ? (b.path && (h = b.path + h), g = k.image(h, 0, 0, l, l)) : (g = this.createMarker(c, d, e, void 0, void 0, void 0, void 0, g)) && g.translate(l /
            2, l / 2);
        this.addListeners(g, a);
        k = k.set([g]);
        this.switchable && k.setAttr("cursor", "pointer");
        (f = this.switchType) && "none" != f && ("x" == f ? (s = this.createX(), s.translate(l / 2, l / 2)) : s = this.createV(), s.dItem = a, !0 !== a.hidden ? "x" == f ? s.hide() : s.show() : "x" != f && s.hide(), this.switchable || s.hide(), this.addListeners(s, a), a.legendSwitch = s, k.push(s));
        f = this.color;
        ...
        s = this.fontSize;
        g && l <= s && g.translate(n, l / 2 + this.ly - s / 2 + (s + 2 - l) / 2 - p);
        var q;
        d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, q = AmCharts.text(this.container, d, f, b.fontFamily, s, "start"), q.translate(this.lx + m, this.ly), k.push(q), b = q.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
    ...
    rollOverMarker: function (a) {
        ...
        this.switchable && (!0 === a.hidden ? this.dispatch("showItem", a) : this.dispatch("hideItem", a));
        this.dispatch("clickMarker", a)
        ...
        this.fire(a,
            {type: a, dataItem: b, target: this, chart: this.chart})
        ...
        for (c = 0; c < a.length; c++) {
            ...
            if (d)f.value ? e.text(f.value) : e.text(""); else {
                if (void 0 !== f.type) {
                    ...
                    h ? (g = this.valueText, f.legendValueText && (g = f.legendValueText), g = b.formatString(g, h)) :
                        k && (g = b.formatPeriodString(k, f))
                } else g = b.formatString(this.valueText, f);
                (h = f.legendLabel) && h.text(f.legendTextReal);
                e.text(g)
            }
        }
    }, renderFix: function () {
